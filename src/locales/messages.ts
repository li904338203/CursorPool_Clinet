export const messages = {
  ...
  'en-US': {
    ...
    dashboard: {
      ...
      cpUsage: 'Cursor Agent Credit Usage',
  ...
  'fr-FR': {
    ...
    dashboard: {
      ...
      cpUsage: 'Utilisation des crédits Cursor Agent',
  ...
  'de-DE': {
    ...
    dashboard: {
      ...
      cpUsage: 'Cursor Agent-Guthaben-Nutzung',
    ...
    systemControl: {
      ...
      messages: {
        ...
        applyHookSuccess: 'Hook appliziert',
        restoreHookSuccess: 'Hook wiederhergestellt',
  ...
  'ru-RU': {
    ...
    dashboard: {
      ...
      cpUsage: 'Использование кредитов Cursor Agent',
  ...
  'es-AR': {
    ...
    dashboard: {
      ...
      cpUsage: 'Utilización de créditos de Cursor Agent',
    ...
    common: {
      ...
      cursorRunningMessage: 'Cursor está en ejecución, veuillez sauvegarder votre projet avant de continuer !',
